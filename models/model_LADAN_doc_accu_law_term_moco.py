...
class MoCo(nn.Module):
    ...
    def predict(self, legals, legals_len, sent_lent,accu_label_lists, law_label_lists, term_lists):
        # compute query features
        accu_loss, law_loss, term_loss, law_article_loss, graph_choose_loss, accu_preds, law_preds, term_preds, law_article_preds, graph_preds, q_doc_feature, q_accu_feature, q_law_feature, q_term_feature = self.encoder_q(legals, accu_label_lists, law_label_lists, term_lists, sent_lent, legals_len)
