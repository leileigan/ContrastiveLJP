...
class MoCo(nn.Module):
    ...
    def forward(self, legals, type_ids_list, attention_mask_list, accu_label_lists, law_label_lists, term_lists):
        ...
        with torch.no_grad():  # no gradient to keys
            ...
            _, _, _, _, _, _, k_doc_feature, k_accu_feature, k_law_feature, k_term_feature = self.encoder_k(legals, type_ids_list, attention_mask_list, accu_label_lists, law_label_lists, term_lists)
