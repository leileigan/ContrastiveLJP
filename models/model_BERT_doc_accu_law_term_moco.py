...
class LawModel(nn.Module):
    ...
    def forward(self, input_facts, type_ids_list, attention_mask_list, accu_labels, law_labels, term_labels):
        """
        Args:
...
class MoCo(nn.Module):
    ...
    def forward(self, legals, type_ids_list, attention_mask_list, accu_label_lists, law_label_lists, term_lists):
        ...
        accu_loss, law_loss, term_loss, accu_preds, law_preds, term_preds, q_doc_feature, q_accu_feature, q_law_feature, q_term_feature = self.encoder_q(
            legals, type_ids_list, attention_mask_list, accu_label_lists, law_label_lists, term_lists)
        ...
        with torch.no_grad():  # no gradient to keys
            ...
            _, _, _, _, _, _, k_doc_feature, k_accu_feature, k_law_feature, k_term_feature = self.encoder_q(legals, type_ids_list, attention_mask_list, accu_label_lists, law_label_lists, term_lists)
    ...
    def predict(self, legals, type_ids_list, attention_mask_list, accu_label_lists, law_label_lists, term_lists):
        # compute query features
        accu_loss, law_loss, term_loss, accu_preds, law_preds, term_preds, q_doc_feature, q_accu_feature, q_law_feature, q_term_feature = self.encoder_q(legals, type_ids_list, attention_mask_list, accu_label_lists, law_label_lists, term_lists)
