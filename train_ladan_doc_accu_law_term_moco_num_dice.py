...
from models.model_LADAN_doc_accu_law_term_moco_num_dice import MoCo
...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default=BASE+"/results/LADAN/LADAN_doc_accu_law_term_moco_num_dice")
