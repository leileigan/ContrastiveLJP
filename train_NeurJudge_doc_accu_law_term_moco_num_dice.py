...
from models.model_NeurJudge_doc_accu_law_term_moco_num_dice import MoCo
    ...
    for idx in range(config.HP_iteration):
        ...
        for batch_idx, datapoint in enumerate(train_dataloader):
            ...
            contra_doc_loss, contra_accu_loss, contra_law_loss, contra_term_loss, accu_loss, law_loss, term_loss, accu_preds, law_preds, term_preds = \
                ...
                charge_tong2id,id2charge_tong,art2id,id2art,documents, \
                config.MAX_SENTENCE_LENGTH,process, DEVICE, accu_label_lists, law_label_lists, term_lists, money_lists)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default=BASE+"/results/NeurJudge/NeurJudge_doc_accu_law_term_moco_num_dice")
